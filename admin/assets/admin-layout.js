...
(function () {
    ...
    function buildLoginSection() {
        return [
            ...
            '    <form id="login-form">',
            '        <div class="form-group" style="position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0;" aria-hidden="true">',
            '            <label for="username">Username</label>',
            '            <input type="text" id="username" name="username" autocomplete="username" tabindex="-1" readonly>',
            '        </div>',
